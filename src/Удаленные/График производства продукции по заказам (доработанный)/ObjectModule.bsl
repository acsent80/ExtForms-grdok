...
Функция СведенияОВнешнейОбработке() Экспорт
    ...
    ПараметрыРегистрации.Вставить("Наименование", "График производства продукции по заказам (доработанный)");
    ...
    ПараметрыРегистрации.Вставить("Информация", "График производства продукции по заказам (доработанный)");
    
    // Создадим таблицу команд (подробнее смотрим ниже)
    ТаблицаКоманд = ПолучитьТаблицуКоманд();
    
    // Добавим команду в таблицу
    ДобавитьКоманду(ТаблицаКоманд, "График производства продукции по заказам (доработанный)", "ГрафикПроизводстваПродукции_Доработанный", "ОткрытиеФормы", Истина, "ПечатьMXL");
