...
Функция СведенияОВнешнейОбработке() Экспорт
    ...
    ПараметрыРегистрации.Вставить("Наименование", "Количество внесенных составов бригад (Дополнительный)");
    ...
    ПараметрыРегистрации.Вставить("Информация", "Количество внесенных составов бригад (Дополнительный)");
    
    // Создадим таблицу команд (подробнее смотрим ниже)
    ТаблицаКоманд = ПолучитьТаблицуКоманд();
    
    // Добавим команду в таблицу
    ДобавитьКоманду(ТаблицаКоманд, "Количество внесенных составов бригад (Дополнительный)", "КоличествоВнесенныхСоставовБригад", "ОткрытиеФормы", Истина, "");
