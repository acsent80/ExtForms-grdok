...
Функция СведенияОВнешнейОбработке() Экспорт
    ...
    ПараметрыРегистрации.Вставить("Наименование", "Зарплата к выплате");
    ...
    ПараметрыРегистрации.Вставить("Информация", "Зарплата к выплате");
    
    // Создадим таблицу команд (подробнее смотрим ниже)
    ТаблицаКоманд = ПолучитьТаблицуКоманд();
    
    // Добавим команду в таблицу
    ДобавитьКоманду(ТаблицаКоманд, "Зарплата к выплате (Внешний)", "", "ОткрытиеФормы", Истина, "ПечатьMXL");
