...
Функция СведенияОВнешнейОбработке() Экспорт
    ...
    ПараметрыРегистрации.Вставить("Наименование", "Ожидаемый выпуск v3 (дополнительный)");
    ...
    ПараметрыРегистрации.Вставить("Информация", "Ожидаемый выпуск v3 (дополнительный)");
    
    // Создадим таблицу команд (подробнее смотрим ниже)
    ТаблицаКоманд = ПолучитьТаблицуКоманд();
    
    // Добавим команду в таблицу
    ДобавитьКоманду(ТаблицаКоманд, "Ожидаемый выпуск v3 (дополнительный)", "ОжидаемыйВыпуск_v3", "ОткрытиеФормы", Истина, "");
