...
Функция СведенияОВнешнейОбработке() Экспорт
    ...
    ПараметрыРегистрации.Вставить("Наименование", "Отчет по показателям расчета зарплаты за период (Дополнительный)");
    ...
    ПараметрыРегистрации.Вставить("Информация", "Отчет по показателям расчета зарплаты за период (дополнительный)");
    
    // Создадим таблицу команд (подробнее смотрим ниже)
    ТаблицаКоманд = ПолучитьТаблицуКоманд();
    
    // Добавим команду в таблицу
    ДобавитьКоманду(ТаблицаКоманд, "Отчет по показателям расчета зарплаты за период (дополнительный)", "ОтчетПоПоказателямРасчетаЗарплаты", "ОткрытиеФормы", Истина, "");
