...
//Сделано на основании статей
// http://www.1c-pro.ru/topic39219.html
// http://devtrainingforum.v8.1c.ru/forum/thread.jsp?id=583504&print=1
// 
// Чуть-чуть информации подсмотрено здесь
// http://infostart.ru/public/76427/
// и здесь
// http://infostart.ru/public/84001/
...
Функция СведенияОВнешнейОбработке() Экспорт
    ...
    ПараметрыРегистрации.Вставить("Наименование", "Закупки по контрагентам и датам");
    ...
    ПараметрыРегистрации.Вставить("Информация", "Закупки по контрагентам и датам");
    
    // Создадим таблицу команд (подробнее смотрим ниже)
    ТаблицаКоманд = ПолучитьТаблицуКоманд();
    
    // Добавим команду в таблицу
    ДобавитьКоманду(ТаблицаКоманд, "Закупки по контрагентам и датам", "ЗакупкиПоКонтрагентамИДатам", "ОткрытиеФормы", Истина, "ПечатьMXL");
