...
Функция СведенияОВнешнейОбработке() Экспорт
    ...
    ПараметрыРегистрации.Вставить("Наименование", "Разница Маршрутный лист / Приходный ордер на склад (Дополнительный)");
    ...
    ПараметрыРегистрации.Вставить("Информация", "Разница Маршрутный лист / Приходный ордер на склад (Дополнительный)");
    
    // Создадим таблицу команд (подробнее смотрим ниже)
    ТаблицаКоманд = ПолучитьТаблицуКоманд();
    
    // Добавим команду в таблицу
    ДобавитьКоманду(ТаблицаКоманд, "Разница Маршрутный лист / Приходный ордер на склад (Дополнительный)", "Разница_МЛ_Ордер", "ОткрытиеФормы", Истина, "");
