...
Функция СведенияОВнешнейОбработке() Экспорт
    ...
    ПараметрыРегистрации.Вставить("Наименование", "Ведомость приемки на склад по ордерам (дополнительный)");
    ...
    ПараметрыРегистрации.Вставить("Информация", "Ведомость приемки на склад по ордерам (дополнительный)");
    
    // Создадим таблицу команд (подробнее смотрим ниже)
    ТаблицаКоманд = ПолучитьТаблицуКоманд();
    
    // Добавим команду в таблицу
    ДобавитьКоманду(ТаблицаКоманд, "Ведомость приемки на склад по ордерам (дополнительный)", "ВедомостьПриемкиНаСкладПоОрдерам", "ОткрытиеФормы", Истина, "ПечатьMXL");
