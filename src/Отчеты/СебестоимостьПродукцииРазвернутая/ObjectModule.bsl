...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Для каждого СтрокаТЗ из Данные Цикл
		СтрокаТЗ.КоличествоЗатрат = _ОбщегоНазначенияДоп.ЕстьNULL(СтрокаТЗ.КоличествоЗатрат, 0);
		СтрокаТЗ.СтоимостьЗатрат  = _ОбщегоНазначенияДоп.ЕстьNULL(СтрокаТЗ.СтоимостьЗатрат, 0);
	КонецЦикла;	
