...
Функция СведенияОВнешнейОбработке() Экспорт
    ...
    ПараметрыРегистрации.Вставить("Наименование", "Выпуск продукции со средней толщиной (Дополнительный)");
    ...
    ПараметрыРегистрации.Вставить("Информация", "Выпуск продукции со средней толщиной (Дополнительный)");
    
    // Создадим таблицу команд (подробнее смотрим ниже)
    ТаблицаКоманд = ПолучитьТаблицуКоманд();
    
    // Добавим команду в таблицу
    ДобавитьКоманду(ТаблицаКоманд, "Выпуск продукции со средней толщиной (Дополнительный)", "ОжидаемыйВыпускСоСреднейТолщиной", "ОткрытиеФормы", Истина, "");
