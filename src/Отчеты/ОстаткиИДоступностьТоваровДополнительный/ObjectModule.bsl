...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ПараметрыРегистрации.Вставить("Наименование", "Остатки и доступность товаров (дополнительный)");
	...
	ПараметрыРегистрации.Вставить("Информация", "Остатки и доступность товаров (дополнительный)");
	
	// Создадим таблицу команд (подробнее смотрим ниже)
	ТаблицаКоманд = ПолучитьТаблицуКоманд();
	
	// Добавим команду в таблицу
	ДобавитьКоманду(ТаблицаКоманд, "Остатки и доступность товаров (дополнительный)", "", "ОткрытиеФормы", Истина, "ПечатьMXL");
