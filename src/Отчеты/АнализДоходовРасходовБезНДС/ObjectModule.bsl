...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ПараметрыРегистрации.Вставить("Наименование", "Доходы и расходы без НДС");
	...
	ПараметрыРегистрации.Вставить("Информация", "Доходы и расходы без НДС");
	
	// Создадим таблицу команд (подробнее смотрим ниже)
	ТаблицаКоманд = ПолучитьТаблицуКоманд();
	
	// Добавим команду в таблицу
	ДобавитьКоманду(ТаблицаКоманд, "Доходы и расходы без НДС", "", "ОткрытиеФормы", Истина, "ПечатьMXL");
