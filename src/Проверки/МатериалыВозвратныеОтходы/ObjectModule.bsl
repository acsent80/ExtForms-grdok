...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ПараметрыРегистрации.Вставить("Наименование", "Материалы - возвратные отходы");
	...
	ПараметрыРегистрации.Вставить("Информация", "Отчет по маргрутным листам, где материалы являются также возвратными отходами");
	
	// Создадим таблицу команд (подробнее смотрим ниже)
	ТаблицаКоманд = ПолучитьТаблицуКоманд();
	
	// Добавим команду в таблицу
	ДобавитьКоманду(ТаблицаКоманд, "Материалы - возвратные отходы", "", "ОткрытиеФормы", Истина, "ПечатьMXL");
