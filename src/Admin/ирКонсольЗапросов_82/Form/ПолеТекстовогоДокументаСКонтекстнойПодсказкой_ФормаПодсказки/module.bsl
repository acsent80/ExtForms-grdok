...
Процедура ПодобратьСтроку(ЛиПередОткрытием = Ложь)
	...
	Если ЛиНазад Тогда
		...
		СтрокаСлова = ПодходящиеСлова.НайтиСтроки(СтруктураКлюча)[0];
...
Процедура ПриОткрытии()
	...
	Тогда 
		ЭлементыФормы.ТаблицаСлов.ВыделенныеСтроки.Очистить();
	КонецЕсли;
	ТипКонтекста = ирПлатформа.ПолучитьСтрокуКонкретногоТипа(СтруктураТипаКонтекста);
...
Процедура ПодходящиеСловаПриВыводеСтроки(Элемент, ОформлениеСтроки, ДанныеСтроки)
	...
	Если ДанныеСтроки.ТипСлова = "Конструкция" Тогда
		ЯчейкаКартинки.ИндексКартинки = 13;
	ИначеЕсли ДанныеСтроки.ТипЗначения = "Имя типа" Тогда
		ЯчейкаКартинки.ИндексКартинки = 12;
	ИначеЕсли ДанныеСтроки.ТипСлова = "Метод" Тогда
		Если ДанныеСтроки.ТипЗначения = "" Тогда
			...
			ИначеЕсли ДанныеСтроки.Определение = "Метаданные" Тогда
				ЯчейкаКартинки.ИндексКартинки = 6;
			//ИначеЕсли ДанныеСтроки.Определение = "Локальный" Тогда
			//	ЯчейкаКартинки.ИндексКартинки = 9;
			Иначе
		...
		Иначе
			...
			ИначеЕсли ДанныеСтроки.Определение = "Метаданные" Тогда
				ЯчейкаКартинки.ИндексКартинки = 7;
			//ИначеЕсли ДанныеСтроки.Определение = "Локальный" Тогда
			//	ЯчейкаКартинки.ИндексКартинки = 10;
			Иначе
				ЯчейкаКартинки.ИндексКартинки = 4;
			КонецЕсли;	
		КонецЕсли;
	ИначеЕсли ДанныеСтроки.ТипСлова = "Свойство" Тогда
		...
		ИначеЕсли ДанныеСтроки.Определение = "Метаданные" Тогда
			ЯчейкаКартинки.ИндексКартинки = 8;
		//ИначеЕсли ДанныеСтроки.Определение = "Локальный" Тогда
		//	ЯчейкаКартинки.ИндексКартинки = 11;
		Иначе
			ЯчейкаКартинки.ИндексКартинки = 5;
		КонецЕсли;
	ИначеЕсли ДанныеСтроки.ТипСлова = "Таблица" Тогда
		ЯчейкаКартинки.ИндексКартинки = 14;
	ИначеЕсли ДанныеСтроки.ТипСлова = "Поле" Тогда
		Если ДанныеСтроки.Определение = "Предопределенный" Тогда
			ЯчейкаКартинки.ИндексКартинки = 15;
		Иначе
			ЯчейкаКартинки.ИндексКартинки = 16;
		КонецЕсли;
	КонецЕсли;
...
Процедура ПриИзмененииОтбора(ИмяДанных = "")
	...
	ВременнныйПостроительЗапроса.ИсточникДанных = Новый ОписаниеИсточникаДанных(ТаблицаСлов);
	ЛксСкопироватьОтборДинамическогоСписка(ВременнныйПостроительЗапроса.Отбор, ЭлементыФормы.ТаблицаСлов.ОтборСтрок, Истина);
...
Процедура КоманднаяПанельФормыКонтекстнаяСправка(Кнопка)
	...
	ВладелецФормы.ОткрытьКонтекстнуюСправку(ПутьКСлову);
	// --
