...
Процедура ПрочитатьНомераСообщений()
	Данные = ОбъектОбработка().ПолучитьПараметрыУзлаОбмена(УзелОбменаСсылка, "НомерОтправленного, НомерПринятого, ВерсияДанных");
...
Процедура ЗаписатьНомераСообщений()
	...
	ОбъектОбработка().УстановитьПараметрыУзлаОбмена(УзелОбменаСсылка, Данные);
КонецПроцедуры
