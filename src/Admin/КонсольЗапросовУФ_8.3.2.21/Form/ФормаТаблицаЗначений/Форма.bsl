...
&НаКлиенте
Процедура _СоздатьТекстЗаписьРегистраСведений(Команда)
...
&НаКлиенте
Процедура _СоздатьТекстЗаписьРегистраНакопления(Команда)
...
&НаКлиенте
Процедура _СоздатьЗаписьЗапись(Команда)

	Текст = 
	"Для каждого Строка Из Результат Цикл
	|	
	|	СпрОбъект = Строка.Ссылка.ПолучитьОбъект();
	|	//ЗаполнитьЗначенияСвойств(СпрОбъект, Строка);
	|	//СпрОбъект. = 
...
&НаКлиенте
Процедура _СоздатьЗаписьУдаление(Команда)
