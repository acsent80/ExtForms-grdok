...
&НаКлиенте
Процедура ОтборТолщинаЗначениеПриИзменении(Элемент)
	Объект.ОтборТолщина = Истина;
КонецПроцедуры

&НаКлиенте
Процедура ОтборРадиусЗначениеПриИзменении(Элемент)
	Объект.ОтборРадиус = Истина;
КонецПроцедуры
