...
Функция СформироватьПечатнуюФорму(МассивОбъектов, ОбъектыПечати, ИмяМакета)
	...
	Пока Шапка.Следующий() Цикл
		...
		Если ЗначениеЗаполнено(Шапка.СчетОрганизации.БанкДляРасчетов)
			Или ЗначениеЗаполнено(Шапка.СчетОрганизации.БИКБанкаДляРасчетов)
			Или ЗначениеЗаполнено(Шапка.СчетОрганизации.СВИФТБанкаДляРасчетов) Тогда
			
			ДанныеШапки.ОрганизацияБанк = ДанныеШапки.ОрганизацияБанк + Символы.ПС +
				_ОбщегоНазначенияДоп.ЗаполнитьПоШаблону(ШаблонБанкПосредник, ДанныеШапки);
			
			ДанныеШапки.ОрганизацияБанкEN = ДанныеШапки.ОрганизацияБанкEN + Символы.ПС +
				_ОбщегоНазначенияДоп.ЗаполнитьПоШаблону(ШаблонБанкПосредник, ДанныеШапки);
