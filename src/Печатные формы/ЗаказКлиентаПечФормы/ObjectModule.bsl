	...
	Пока Шапка.Следующий() Цикл
		...
		Если ВыборкаТовары.НайтиСледующий(Новый Структура("Ссылка", Шапка.Ссылка)) Тогда
			...
			Пока ВыборкаДетали.Следующий() Цикл
				...
				ДанныеСтроки.Вставить("ЕдИзм",     Строка(ВыборкаДетали.ЕдиницаИзмерения));
				ДанныеСтроки.Вставить("ЕдИзмEN",   Строка(ВыборкаДетали.ЕдиницаИзмерения.МеждународноеСокращение));
