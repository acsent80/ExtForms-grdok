...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ДобавитьКоманду(ТаблицаКоманд,
		"Заявка (RUS)", // Представление команды в пользовательском интерфейсе
		"Заявка_RUS",	// Уникальный идентификатор команды
		);
...
Процедура Печать(МассивОбъектовНазначения, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "Заявка_RUS") Тогда
		
		ТабличныйДокумент = СформироватьПечатнуюФорму(МассивОбъектовНазначения, ОбъектыПечати, "ПФ_MXL_Заявка_RUS");
...
Функция СформироватьПечатнуюФорму(МассивОбъектов, ОбъектыПечати, ИмяМакета)
	...
	Пока Шапка.Следующий() Цикл
		...
		КонецЕсли;	
		ДанныеШапки.Вставить("ДатаОтгрузки",         Формат(Шапка.ДатаОтгрузки, "ДФ=dd.MM.yyyy"));
