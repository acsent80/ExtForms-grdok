...
Функция ПечатьИнвойс(МассивОбъектов, ОбъектыПечати, ИмяМакета)
	...
	Пока Шапка.Следующий() Цикл
		...
		ДанныеШапки.Вставить("Организация",       ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Шапка.Контрагент, "НаименованиеПолное"));
		...
		Если ВыборкаТовары.НайтиСледующий(Новый Структура("Ссылка", Шапка.Ссылка)) Тогда
			...
			Пока ВыборкаДетали.Следующий() Цикл
				...
				ДанныеСтроки.Вставить("Характеристика",  ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ВыборкаДетали.Характеристика, "НаименованиеПолное"));
