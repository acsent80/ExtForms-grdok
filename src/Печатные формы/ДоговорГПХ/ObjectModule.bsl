...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ДобавитьКоманду(ТаблицаКоманд,
		"Договор ГПХ (Внешняя печ. форма)", // Представление команды в пользовательском интерфейсе
		"ДоговорГПХ",						// Уникальный идентификатор команды
	);
...
Функция ТекстЗапросаШапки()
	...
	|	Сотрудники.ФизическоеЛицо.СтраховойНомерПФР КАК РаботникСтраховойНомерПФР,
...
Процедура Печать(МассивОбъектовНазначения, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ДоговорГПХ") Тогда
		
		ТабличныйДокумент = СформиоватьТабДок(МассивОбъектовНазначения, ОбъектыПечати, "ПФ_MXL_ДоговорГПХ");
		
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(
			КоллекцияПечатныхФорм,
			"ДоговорГПХ",
			"Договор ГПХ (Внешняя печ. форма)",
			ТабличныйДокумент
		);
