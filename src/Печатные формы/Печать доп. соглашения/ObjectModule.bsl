...
Функция ПечатьДопсоглашениеВнешняя(МассивОбъектов, ОбъектыПечати, ИмяМакета)
	...
	//|	ПлановыеНачисленияСрезПоследних.Начисление.Наименование КАК Начисление
	//|ИЗ
	//|	РегистрСведений.ПлановыеНачисления.СрезПоследних(&Дата, ) КАК ПлановыеНачисленияСрезПоследних
	//|ГДЕ
	//|	ПлановыеНачисленияСрезПоследних.Сотрудник = &Сотрудник";
	"ВЫБРАТЬ
	|	ЗначенияСовокупныхТарифныхСтавокСотрудниковСрезПоследних.Значение КАК Размер,
	|	ЗначенияСовокупныхТарифныхСтавокСотрудниковСрезПоследних.ВидТарифнойСтавки КАК Начисление
	|ИЗ
	|	РегистрСведений.ЗначенияСовокупныхТарифныхСтавокСотрудников.СрезПоследних(&Дата, Сотрудник = &Сотрудник) КАК ЗначенияСовокупныхТарифныхСтавокСотрудниковСрезПоследних";
