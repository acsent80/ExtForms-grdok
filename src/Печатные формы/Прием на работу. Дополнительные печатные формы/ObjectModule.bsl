...
Процедура СоздатьВТОбщиеДанныеСправок(МенеджерВременныхТаблиц, МассивОбъектов)
	...
	Пока Выборка.Следующий() Цикл
		...
		НоваяСтрокаСведенияОбОрганизациях.ОрганизацияРасчетныйСчет = Выборка.Организация.ОсновнойБанковскийСчет.НомерСчета;
		НоваяСтрокаСведенияОбОрганизациях.ОрганизацияБанк = Выборка.Организация.ОсновнойБанковскийСчет.Банк.Наименование;
		НоваяСтрокаСведенияОбОрганизациях.ОрганизацияКорСчет = Выборка.Организация.ОсновнойБанковскийСчет.Банк.КоррСчет;
		НоваяСтрокаСведенияОбОрганизациях.ОрганизацияБИК = Выборка.Организация.ОсновнойБанковскийСчет.Банк.Код;
