...
Функция ДанныеДляПечатиТрудовогоДоговора(МассивОбъектов, ИмяМакета)
	...
	Запрос.Текст =
		...
		|	ДанныеПриказаОПриеме.Ссылка.ГрафикРаботы КАК ГрафикРаботы,
		|	ВЫБОР
	...
	Пока Выборка.Следующий() Цикл
		...
		ПараметрыТрудовогоДоговора.Вставить("ГрафикРаботы",     Выборка.ГрафикРаботы);
		ПараметрыТрудовогоДоговора.Вставить("ОснованиеСрочногоДоговора", Выборка.Ссылка.ОснованиеСрочногоДоговора);
		ПараметрыТрудовогоДоговора.Вставить("СрокЗаключенияДоговора",    Выборка.Ссылка.СрокЗаключенияДоговора);
		//Ситников--
