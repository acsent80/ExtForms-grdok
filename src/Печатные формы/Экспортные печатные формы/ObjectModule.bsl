...
Процедура ЗаполнитьТабличныйДокумент(ТабличныйДокумент, ДанныеДляПечати, ОбъектыПечати, КомплектыПечати, ИмяПФ, ОтдельнаяСтрокаНаименование = Ложь)
	...
	Пока Шапка.Следующий() Цикл
		...
		Для Каждого СтрокаТовары Из ТаблицаТовары Цикл
			...
			СтруктураДанныхСтроки.Вставить("ОписаниеRUS",       ПолучитьДопРеквизитНоменклатуры(СтрокаТовары.Номенклатура, СвойствоОписаниеRUS));
			СтруктураДанныхСтроки.Вставить("ОписаниеENG",       ПолучитьДопРеквизитНоменклатуры(СтрокаТовары.Номенклатура, СвойствоОписаниеENG));
