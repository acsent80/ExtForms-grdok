...
Процедура ЗаполнитьТабличныйДокумент(ТабличныйДокумент, ДанныеДляПечати, ОбъектыПечати, КомплектыПечати, ИмяПФ, ОтдельнаяСтрокаНаименование = Ложь)
	...
	Пока Шапка.Следующий() Цикл
		...
		СтруктураДанныхШапки.Вставить("AccountWithCorrespondentBank",   ПолучитьДопРеквизит(СчетОрганизации, Свойства.AccountWithCorrespondentBank));
		СтруктураДанныхШапки.Вставить("СчетБанкENG",                    ПолучитьДопРеквизит(СчетОрганизации, Свойства.BeneficiarysName));
		СтруктураДанныхШапки.Вставить("СчетБанкAddress",                ПолучитьДопРеквизит(СчетОрганизации, Свойства.БанкAddress));
...
Функция ПолучитьСтруктуруСвойств()
	...
	Структура.Вставить("БанкAddress",      ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.НайтиПоНаименованию("Address (Банковские счета)",                     Истина));
	Структура.Вставить("BeneficiarysName", ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.НайтиПоНаименованию("Beneficiary’s name (Банковские счета)",          Истина));
	...
	Структура.Вставить("AccountWithCorrespondentBank", ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.НайтиПоНаименованию("Account with correspondent bank (Банковские счета)", Истина));
